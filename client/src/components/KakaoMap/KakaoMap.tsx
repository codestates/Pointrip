    ...
    if (addressInput !== "") {
      geocoder.addressSearch(addressInput, function (result: any, status: any) {
        ...
        if (status === window.kakao.maps.services.Status.OK) {
          ...
          const imageSrc = "images/mapMark.svg"; // 마커 이미지 주소
          ...
          <span style="font-family: Gmarket Sans TTF; color: #2d2d2d; font-weight: 300; font-size: 1rem; margin-bottom: 5px;">Pontrip</span>
